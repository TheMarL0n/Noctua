...
export default function History() {
    ...
    const historySS: [] = JSON.parse(localStorage.getItem("history") ?? '[]');
...

            {
                historySS.length === 0 ?
                    ...
                    <div className="folders-list flex flex-col items-center justify-center mt-40">
                        ...
                        <h2 className='text-gray-three text-[36px] my-4'>No hay entradas en este historial</h2>
                        <p className='text-custom-regular text-white flex items-center gap-2'><span className="material-symbols-outlined text-warning text-[16px]">warning</span> Usa la Noctua® y aquí podrás ver las acciones realizadas </p>
                    </div>
                    :
                    <>
                                ...
                                (items.map((item, idx) => (
                                    ...
                                    >
                                        <div className='p-1 flex gap-2 items-center flex-1'>
                                            ...
                                            <span className="material-symbols-outlined text-[25px] leading-[20px] text-gray-seven dark:text-white-one text-center">chat</span>
                                            <p className='text-[17px] text-gray-seven dark:text-white-one'>{item.pregunta}</p>
                                        </div>
                                    </div>
                                )))
                                :
