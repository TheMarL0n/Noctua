...
export default function DashboardLayout({
  ...
  const wrapperClasses = classNames(
    ...
    {
      ["w-20 sm:w-80 md:w-80 lg:w-80"]: !toggleCollapse,
      ["w-20"]: toggleCollapse,
    }
  );
  ...
  return (
    <main className="min-h-screen flex flex-row justify-start items-start bg-white dark:bg-main-c">
      ...
      >
        ...
        {toggleCollapse ? (
          <Sidebar collapsed="" notCollapsed="hidden" />
        ) : (
          <Sidebar collapsed="hidden" notCollapsed="" />
        )}
      </div>
      <div
      ...
      <Notification
        isOpen={modalExpiredOpen}
        onClose={() => {
          setModalExpiredOpen(false);
        }}
      >
        <div>
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-secundary-c dark:text-main-text-color text-[20px] mb-2 font-bold">
                Tu sesión ha expirado
              </h3>
              <p className="text-secundary-c dark:text-main-text-color text-[14px]">
