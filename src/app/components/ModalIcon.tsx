    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-[99]">
      <div className="modal-content bg-white dark:bg-gray-three rounded-lg px-3 py-2 xl:w-[574px] lg:w-[574px] md:w-[574px] max-w-[574px] shadow-lg transition-transform duration-300">
        <div className="modal-header justify-between flex border-b border-gray-five">
          <p className="text-[20px] font-light text-gray-five dark:text-main-text-color pb-1 flex gap-2 items-center">
            <span className="material-symbols-outlined text-[45px] text-blue-one">{icon}</span>
            {title}
          </p>
